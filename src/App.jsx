...
function buildDynamicSchedule(ignitionTimes = {}, customEvents = {}, generatedSchedules = {}) {
  ...
  for (let d = new Date(start); d <= end; d.setDate(d.getDate() + 1)) {
    ...
    else if (dayNum <= 13) { dsaTopic = "Binary Trees"; dsaQ = 3; } // 35 Qs / 12 days
    else if (dayNum <= 21) { dsaTopic = "Binary Search Trees"; dsaQ = 2; } // 15 Qs / 8 days
    else if (dayNum <= 26) { dsaTopic = "Heaps"; dsaQ = 3; } // 15 Qs / 5 days
    else if (dayNum <= 41) { dsaTopic = "Graphs"; dsaQ = 4; } // 54 Qs / 15 days
    else if (dayNum <= 51) { dsaTopic = "DP Introduction"; dsaQ = 2; } // 20 Qs / 10 days
    else if (dayNum <= 66) { dsaTopic = "DP Mastery"; dsaQ = 3; } // 36 Qs / 15 days
    else if (dayNum <= 73) { dsaTopic = "Tries"; dsaQ = 1; } // 7 Qs / 7 days
    else if (dayNum <= 81) { dsaTopic = "Advanced Strings"; dsaQ = 2; } // 15 Qs / 8 days
